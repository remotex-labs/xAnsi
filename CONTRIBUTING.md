# Contributing to @remotex-labs/xansi

Thank you for your interest in contributing! Every bug report, documentation fix, and feature addition makes xAnsi better for everyone.
...
Click the **Fork** button at the top right of the [xAnsi repository](https://github.com/remotex-labs/xAnsi) on GitHub. This creates a copy of the repo under your own account.

### 2. Clone your fork

```bash
git clone https://github.com/<your-username>/xAnsi.git
cd xAnsi
```
...
```bash
git remote -v
# origin    https://github.com/<your-username>/xAnsi.git (fetch)
# origin    https://github.com/<your-username>/xAnsi.git (push)
# upstream  https://github.com/remotex-labs/xAnsi.git (fetch)
# upstream  https://github.com/remotex-labs/xAnsi.git (push)
```
...
2. Make sure the base is set to `remotex-labs/xAnsi` → `master`
...
xAnsi ships a tree-shakeable ESM build.
