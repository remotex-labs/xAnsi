...
/**
 * Moves the cursor home and scrolls the whole visible screen out of sight.
 *
 * @remarks
 ...
 * {@link EraseScrollback} erases those saved lines as well, which is the difference between clearing the view and
 * clearing the history.
 *
 * @example
 * ```ts
 * writeRaw(ClearView); // cursor at row 1 column 1, earlier output still reachable by scrolling up
 * ```
 *
 * @see CursorHome
 * @see EraseScrollback
